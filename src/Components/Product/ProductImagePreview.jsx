        ...
        {selectedProduct?.images?.length > 0 ? (
          selectedProduct.images.slice(0, 3).map((img, index) => (
            <img
              ...
              className={`w-[116px] sm:w-[152px] lg:h-[152px] border object-cover cursor-pointer rounded-[20px] ${
                selectedImage === img ? "border-[#FA8232] border" : ""
              }`}
            />
          ))
        ) : (
      ...
      <div className="flex-grow">
        {selectedImage ? (
          <img
            ...
            className="w-[490px] h-auto object-cover border rounded-[20px]"
          />
        ) : (
